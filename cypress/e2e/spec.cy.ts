...
describe('Scoreboard app', () => {
  ...
  describe('on first load', () => {
    ...
    xit('should display team 2 with a starting score of 0', () => {
      // assert
  ...
  describe('changing team name', () => {
    ...
    xit('should reset the team name when I type in a new name and type *ESC*', () => {
      // act
      clickToChangeTeamName('Team 1')
    ...
    xit('should reset the team name text box when I type in a new name, type *ESC*, and click to change the team name again', () => {
      // act
      clickToChangeTeamName('Team 1')
      cy.focused().type('{selectall}')
      cy.focused().type('New name')
